...
def fix_image_paths():
    ...
    # Pattern per trovare i percorsi delle immagini che iniziano con client/public
    pattern = re.compile(r'coverImage:\s*"(client/public/images/([^"]+))"')
    ...
    for mdx_file in blog_dir.glob("*.mdx"):
        try:
            ...
            # Verifica se ci sono percorsi da correggere
            ...
            if matches:
                ...
                for match in matches:
                    wrong_path = f"client/public/images/{match[0]}"
                    correct_path = f"/images/articles/{match[0]}"
