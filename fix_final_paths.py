#!/usr/bin/env python3
"""
Script definitivo per correggere tutti i percorsi delle immagini nei file MDX del blog.
"""
...
def fix_final_paths():
    """Corregge tutti i percorsi delle immagini nei file MDX del blog."""
    ...
    patterns = [
        # Percorsi con /images/articles//images/articles/articles/ triplo
        (re.compile(r'coverImage:\s*"/images/articles//images/articles/articles/([^"]+)"'), r'coverImage: "/images/articles/\1"'),
        # Percorsi con /images/articles/articles/ doppio
        (re.compile(r'coverImage:\s*"/images/articles/articles/([^"]+)"'), r'coverImage: "/images/articles/\1"'),
        # Percorsi che iniziano con /client/public
        (re.compile(r'coverImage:\s*"?/client/public/images/([^"]+)"?'), r'coverImage: "/images/articles/\1"'),
        # Percorsi che iniziano con client/public
        (re.compile(r'coverImage:\s*"?client/public/images/([^"]+)"?'), r'coverImage: "/images/articles/\1"'),
    ]
