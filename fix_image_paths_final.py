...
def fix_all_image_paths():
    ...
    patterns = [
        # Percorsi con client/public duplicato
        (re.compile(r'coverImage:\s*"/images/articles/client/public/images/([^"]+)"'), r'/images/articles/\1'),
            ...
            for pattern, replacement in patterns:
                ...
                if matches:
                    ...
                    for match in matches:
                        wrong_path = f"/images/articles/client/public/images/{match}" if "client/public" in replacement else f"client/public/images/{match}"
